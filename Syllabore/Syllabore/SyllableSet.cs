...
namespace Syllabore
{
    ...
    {
        /// <summary>
        /// The syllable generator used to generate new syllables if the
        /// syllable set is not yet full.
        /// </summary>
        public SyllableGenerator SyllableGenerator { get; set; }

        /// <summary>
        /// Contains a set of syllables that will be generated by this <see cref="SyllableSet"/>.
        /// When a syllable generator is supplied, this set will be slowly populated
        /// up to a maximum size specified by property *MaximumGeneratedSyllables*.
        /// </summary>
        public List<string> PossibleSyllables { get; set; }

        /// <summary>
        /// The maximum number of syllables to generate. This value has no 
        /// effect if there is no syllable generator supplied.
        /// </summary>
        public int MaximumGeneratedSyllables { get; set; }

        /// <summary>
        /// If true, this <see cref="SyllableSet"/> will only return unique syllables.
        /// </summary>
